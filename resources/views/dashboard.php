        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-gradient-to-r from-[#116936] to-[#24a148] overflow-hidden shadow-lg sm:rounded-2xl text-white relative">
                ...
                <div class="p-8 md:p-10 relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <h3 class="text-2xl md:text-3xl font-extrabold tracking-tight">Selamat Datang di Sistem Informasi Desa Penebal</h3>
                        <p class="text-green-100 mt-2 max-w-2xl text-sm md:text-base">
                            Panel kendali admin untuk mengelola pelayanan surat mandiri masyarakat, publikasi berita, dan monitoring administrasi desa secara aman dan efisien.
                        </p>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Total Pengajuan</p>
                        <h4 class="text-3xl font-black text-gray-900">120</h4>
                        <p class="text-xs text-gray-400 font-medium">Semua jenis layanan berkas</p>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Menunggu Dicek</p>
                        <h4 class="text-3xl font-black text-yellow-600">5</h4>
                        <p class="text-xs text-yellow-600 font-bold flex items-center animate-pulse">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Diverifikasi</p>
                        <h4 class="text-3xl font-black text-green-600">108</h4>
                        <p class="text-xs text-gray-400 font-medium">Selesai / Siap Cetak</p>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md transition-shadow">
                    <div class="space-y-1">
                        <p class="text-xs font-bold text-gray-500 uppercase tracking-wider">Pengajuan Ditolak</p>
                        <h4 class="text-3xl font-black text-red-600">7</h4>
                        <p class="text-xs text-gray-400 font-medium">Berkas tidak valid/salah</p>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
                    <div>
                        <h4 class="text-lg font-extrabold text-gray-900">Akses Navigasi Cepat Perangkat Desa</h4>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <a href="{{ route('admin.surat.index') }}" class="group flex items-start p-4 border border-gray-200 hover:border-[#24a148] hover:bg-[#EDFDF3]/20 rounded-xl transition-all duration-200">
                            ...
                            <div class="space-y-0.5">
                                <span class="block font-bold text-gray-900 group-hover:text-[#116936] transition-colors">Verifikasi Pengajuan Surat</span>
                                <span class="block text-xs text-gray-500">Periksa berkas domisili masuk dari warga dan lakukan cetak otomatis.</span>
                            </div>
                        </a>
                        ...
                        <div class="group flex items-start p-4 border border-gray-150 bg-gray-50 opacity-70 rounded-xl cursor-not-allowed">
                            ...
                            <div class="space-y-0.5">
                                ...
                                <span class="block text-xs text-gray-400">Publikasikan kegiatan, pengumuman resmi, dan dokumentasi galeri desa.</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                    <div class="space-y-4">
                        <div class="flex items-center space-x-2 border-b border-gray-100 pb-3">
                            ...
                            <h4 class="font-extrabold text-gray-800 text-sm uppercase tracking-wider">Implementasi Keamanan</h4>
                        </div>
                        
                        <div class="space-y-3 text-xs text-gray-600 leading-relaxed">
                            <div class="flex items-start">
                                <span class="text-[#24a148] mr-2">✔</span>
                                <p><strong>Secure Document Storage:</strong> Dokumen KTP/KK tersimpan dalam direktori privat terlindungi.</p>
                            </div>
                            <div class="flex items-start">
                                <span class="text-[#24a148] mr-2">✔</span>
                                <p><strong>Image Auto-Compression:</strong> Optimalisasi ukuran file otomatis untuk perlindungan resource penyimpanan server.</p>
                            </div>
                            <div class="flex items-start">
                                <span class="text-[#24a148] mr-2">✔</span>
                                <p><strong>Strict Access Control:</strong> Akses rute pratinjau berkas warga wajib melalui proses autentikasi sistem.</p>
                            </div>
                        </div>
                    </div>
